...
const Page = () => {
  ...
  return (
    ...
    //       <div className="approvalBadge">
    //         <span>100%</span>
    //         <span>{profileData.approval}</span>
    //       </div>
    ...
    //   <div className="mainContent">
        ...
        //     <li onClick={() => scrollToSection('employment')}>Employment Add</li>
        //     <li onClick={() => scrollToSection('education')}>Education Add</li>
       ...
       // {/* Profile Content */}
        ...
        //     <h3>Resume</h3>
        //     <p>NAUKRI_CHANDRA_PRAKASH_KUMAR_pdf</p>
        //     <p>Uploaded on Apr 02, 2025</p>
